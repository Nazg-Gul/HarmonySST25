...
#define DRV_SST25_HOLD_PIN_PORT_CHANNEL_IDX0              PORT_CHANNEL_B
#define DRV_SST25_HOLD_PIN_PORT_BIT_POS_IDX0              PORTS_BIT_POS_1
#define DRV_SST25_WRITE_PROTECT_PIN_PORT_CHANNEL_IDX0     PORT_CHANNEL_B
#define DRV_SST25_WRITE_PROTECT_PIN_BIT_POS_IDX0          PORTS_BIT_POS_2
